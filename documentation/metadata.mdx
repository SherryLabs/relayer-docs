---
title: Metadata
description: Learn about metadata and how to work with it
---
...
Validation ensures your widget is correctly structured and prevents runtime errors.
...
- **Throws**: `RelayerValidationError` or `InvalidMetadataError` if validation fails
...
const metadata: Metadata = {
  ...
  title: 'My Trigger',
  description: 'An awesome Web3 widget',
  actions: [
    {
      type: 'blockchain',
      label: 'Mint NFT',
...
try {
  ...
  // Use validatedMetadata for your widget
} catch (error) {
